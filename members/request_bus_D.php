        ...
        <div class="row-fluid">
          ...
          <div id="block_bg" class="block" style="width: auto">
            <div class="navbar navbar-inner block-header">
              <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Book Trip To Medina or Adenta</div>
            </div>
            <!-- block -->
            <main class="mn-inner">
              <div class="container-fluid">
                            ...
                            <div class="card" style="width:auto;">
                              <div style="display: flex; justify-content: space-between;">
                                ...
                                <div style="width: 50%;">
                                  ...
                                  <div class="input-field col m12 s12">,<p>
                                    <label for="passwordsignup" class="youpasswd">Parent/Guardian's Number </label></p>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="seatModalLabel">Medina & Adenta Bus</h5><br>
                                                    ...
                                                    <div class="content-box">
                                                      <div class="mb-3">
                                                        <table id="seatsDiagram" name="seatNumber" class="form-control">
                                                          <tr>
                                                            <?php
                                                             $result = mysqli_query($conn, "select seatnum from requestbus where destination = 'Medina or Adenta' and trip_status='active'");
                                                             $seatnum = array();
                                                            ...
                                                            for ($i = 1; $i <= 15; $i++) {
                                                              if (in_array($i, $seatnum)) {
                                                                echo "<td tabindex=\"-1\" disabled style=\"background-color: #f1f1f1; color: #999; pointer-events: none;\" id=\"seat-$i\" data-name=\"$i\"><i class=\"fas fa-chair\"></i>$i</td>";
                                                              } else {
                                                                echo "<td id=\"seat-$i\" data-name=\"$i\"><i class=\"fas fa-chair\"></i>$i</td>";
                                                              }
                                                            }
                                                            ?>
                                                          </tr>
...
<div>
                                ...
                                <script>
                                  ...
                                  destinationSelect.addEventListener("change", () => {
                                    if (destinationSelect.value === "Medina") {
                                      amountField.value = "145";
                                    } else if (destinationSelect.value === "Adenta") {
                                      amountField.value = "145";
                                    }  else {
                                      amountField.value = "";
                                    }
