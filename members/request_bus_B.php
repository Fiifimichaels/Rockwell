        ...
        <div class="row-fluid">
          ...
          <div id="block_bg" class="block" style="width: auto">
            <div class="navbar navbar-inner block-header">
              <div class="muted pull-left"><i class="icon-reorder icon-large"></i> Book Trip To Kasoa, Cape Or Takoradi</div>
            </div>
            <!-- block -->
            <main class="mn-inner">
              <div class="container-fluid">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  <h5 class="modal-title" id="seatModalLabel">Kasoa, Cape & Takoradi Bus</h5><br>
